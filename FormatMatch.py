...
normal_paragraph_property = {'jc': 'both', 'line': '360', 'lineRule': 'auto', 'before': None, 'beforeLines': None, 'after': None,
                        'afterLines': None, 'firstLine': '480', 'firstLineChars': '200'}

def matchNormal(doc):
    reference_run_property = None
    reference_paragraph_property = None
    # a = Util.getChildNodesAfterContent()
    for child_node in Util.getChildNodesAfterContent():
